...
type Props = {
  ...
  placeholder?: string;
  hasError:number;
  setError:({ index, errorState }: { index: number; errorState: number; }) => void ;
  setValue: ({ index, valueString }: { index: number;valueString: string;}) => void;
  };
